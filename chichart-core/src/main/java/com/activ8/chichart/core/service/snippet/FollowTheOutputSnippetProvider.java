...
public class FollowTheOutputSnippetProvider extends AbstractSnippetProvider implements SnippetProvider {
    ...
    FollowTheOutputSnippetProvider(SnippetLogic snippetLogic) {
