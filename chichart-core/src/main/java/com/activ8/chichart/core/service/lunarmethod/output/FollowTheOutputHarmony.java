...
public class FollowTheOutputHarmony extends AbstractFollowLunarMethodHarmony {

    public FollowTheOutputHarmony(HarmonyCombinationLogic harmonyCombinationLogic, CombinationLogic combinationLogic) {
